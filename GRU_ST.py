...
class GRU(nn.Module):
    ...
    def forward(self, x):
        ...
        return torch.sum(gru_out, dim=1, keepdim=True)/60
...
# torch.save(best_model, '8-EC-speed/model/GRU_SH_ST.pth')
# torch.save(best_model, '8-EC-speed/model/GRU_SH_STNV.pth')
# torch.save(best_model, '8-EC-speed/model/GRU_SZ_ST.pth')
# torch.save(best_model, '8-EC-speed/model/GRU_SZ_STNV.pth')
# torch.save(best_model, '8-EC-speed/model/GRU_CN_ST.pth')
torch.save(best_model, '8-EC-speed/model/GRU_CN_STNV.pth')
#%%
