...
class TransformerTS(nn.Module):
    ...
    def forward(self, x):
        ...
        return torch.sum(x, dim=1, keepdim=True) / 60
...
total_params = count_parameters(T_model)
print(f"Total Trainable Parameters: {total_params}")
#%%
"""SP indicate the accumulated pred"""

# torch.save(best_model, '8-EC-speed/model/TNN_SH_ST.pth')
# torch.save(best_model, '8-EC-speed/model/TNN_SH_STNV.pth')
# torch.save(best_model, '8-EC-speed/model/TNN_SZ_ST.pth')
# torch.save(best_model, '8-EC-speed/model/TNN_SZ_STNV.pth')
# torch.save(best_model, '8-EC-speed/model/TNN_CN_ST.pth')
torch.save(best_model, '8-EC-speed/model/TNN_CN_STNV.pth')
#%%
"predict"
